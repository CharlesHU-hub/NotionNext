...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '行方春迄', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '正尝试建站', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yukue-harumade.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '语言学&观鸟&外语学习', // 网站关键词 英文逗号隔开
